...
const SHOWN_KEY = 'x-today-ichimai-shown-date'
const HISTORY_KEY = 'x-today-record-history'
const SHUFFLE_KEY = 'x-today-record-shuffle'
const DEFAULT_DAILY_SHUFFLE_LIMIT = 3
const LEGACY_SHOWN_KEYS = [
  'x-tonight-dismissed-date',
  'x-today-record-shown-date',
]
