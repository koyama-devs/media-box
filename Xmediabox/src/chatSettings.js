...
const DEFAULT_REACTION_KEY = 'x-chat-default-reaction'
const ENTER_TO_SEND_KEY = 'x-chat-enter-to-send'
const MESSAGE_SOUND_KEY = 'x-chat-message-sound'
const STICKER_SET_OWNER_KEY = 'x-chat-sticker-set-owner'
const STICKER_SET_GUEST_KEY = 'x-chat-sticker-set-guest'
