...
const SPACE_STORAGE_KEY = 'x-listening-space-id'
const AMBIENT_STORAGE_KEY = 'x-listening-space-ambient'
const FOCUS_STORAGE_KEY = 'x-listening-space-focus'
const SPACE_IMAGES_STORAGE_KEY = 'x-listening-space-images'
